      ...
      <main>
        ...
        <div className="grid mx-auto px-4 md:px-8 lg:px-72 py-8 md:grid-cols-[250px,1fr] gap-6 lg:gap-12 bg-white text-black rounded-lg p-4 sm:p-8">
          ...
          <aside className="space-y-4">
            ...
            <ol className="space-y-3 text-tsh">
              <li>
        ...
        <div className="mx-auto w-full max-w-[90%] py-8">
          <section className="bg-black mt-20 p-12 rounded-lg text-center">
            ...
            <div className="flex justify-center space-x-4">
              <Link href="/signup">
                <button className="bg-yellow-400 text-black hover:bg-yellow-300 px-6 py-3 rounded-md text-tsh font-medium">
                  Sign Up
                </button>
              </Link>
              <Link href="/contact">
                <button className="border border-gray-600 text-white hover:bg-gray-800 px-6 py-3 rounded-md text-tsh font-medium">
                  Contact Us
                </button>
              </Link>
            </div>
