    ...
    return (
        <main className="px-4 py-8 sm:px-6 sm:py-12 md:px-10 md:py-16 lg:px-24 lg:py-32 xl:py-32">
            <div className="text-center mb-10 sm:mb-12 md:mb-16 lg:mb-20">
                <span className='text-xs sm:text-sm md:text-base border-2 border-gray-400 font-bold px-4 py-2 sm:px-6 sm:py-3 rounded-xl inline-block'>
                    Why IAM?
                </span>
                <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mt-6 sm:mt-8'>
            ...
            <div className={`grid grid-cols-1 xl:grid-cols-3 gap-6 sm:gap-8 md:gap-10 lg:gap-12 w-full`}>
                ...
                <div className={`bg-yellow-400 p-6 sm:p-8 md:p-10 lg:p-12 rounded-xl shadow-lg 
                    ...
                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-center mb-4">
                        Our Mission
                    </h3>
                    <p className="text-sm sm:text-base md:text-base text-center flex-grow">
